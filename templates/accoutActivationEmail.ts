export function accountActivationEmailHtml(email: string, activationLink: string) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8" />
        ...
        <table role="presentation" width="560" cellspacing="0" cellpadding="0" class="container" style="max-width:560px;background:#f6f7f9;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td class="px" style="padding:25px 35px;background:#ffffff;">
              <h1 class="h1" style="margin:0 0 12px 0;color:#111827;font-size:22px;line-height:1.3;">Activate your account</h1>
          ...
          <tr><td style="background:#ffffff;"><hr style="border:none;border-top:1px solid #e5e7eb;margin:0;" /></td></tr>
